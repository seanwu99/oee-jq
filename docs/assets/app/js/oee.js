...
var Treeview = function () {
    ...
    return {
        ...
        init: function () {
            ...
            demo5();
            // barChartInit(getNodesByText('COLUMBUS SOUTH'));

            $('#m_tree_5').on("select_node.jstree", function (e, data) {
                cc(data);
                if (data.node.text != 'COLUMBUS SOUTH' && treeDataInit) {
                    treeDataInit = false;
                    return;
                }
            ...
            $("#m_tree_5").on("loaded.jstree", function () {
                // cc('loaded');
                // don't use "#" for ID
                $('#m_tree_5').jstree(true).select_node('COLUMBUS SOUTH');
            });
        }
    };
}();
var treeDataInit = true;
var treeData;
var treeNodes2;
